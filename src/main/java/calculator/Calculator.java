...
public class Calculator extends JFrame {
   ...
   *
   * <p>Our panel consists of two text fields for entering the operands (integers), a combo box for
   * selecting the operations, a button for executing the operations and a text field for displaying
   * the result.
   */
  ...
  private static class JTextFieldVerifier extends InputVerifier {
     ...
     * highlighted in a red colour. Additionally, the focus of the text field will not be released.
     *
     * <p>If the text field does contain an integer, any highlighting will be reset and the focus of
     * the text field will be released.
     *
